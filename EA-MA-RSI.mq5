...
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
#property copyright "JayLabs Corp"
...
enum STRATEGY_IN
  {
   ...
   ONLY_RSI,  // Only RSI
   MA_AND_RSI // Moving Averages + RSI
  };
...
sinput string s3; //---------------------------
input double num_lots                         = 100;           // Number of lots
...
//---
   bool checkOrder = OrderSend(request,response);
//---
